...
const animateNumber = (target: string, index: number) => {
  const numericValue = Number.parseFloat(target.replace(/[^\d.]/g, '')) || 0
      ...
      <div class="bg-nc-card/50 backdrop-blur-sm border border-nc-border/50 rounded-2xl p-6">
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          >
            ...
            >
            <div class="absolute -bottom-1 -right-1 w-4 h-4 bg-green-500 rounded-full border-2 border-nc-background" />
          </div>
